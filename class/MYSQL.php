...
class MYSQL
{
	...
	private $servidor = "mysql:host=127.0.0.1;dbname=caribes_zipdev";
	private $usuario = "caribes_zipdev";
	private $password = "devzip2019";
	private $Conexion;
	private $Consulta;
	private $tmp;
	...
	{
		$fp = fopen(dirname(dirname(__FILE__)) . 'db.log','a');
